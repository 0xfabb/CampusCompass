...
const ClubPicStyle = () => {
  ...
  return (
    <div className="max-h-[550px] overflow-y-scroll overflow-x-hidden scroll-m-2 hide-scrollbar hover:scrollbar-thin hover:scrollbar-thumb-gray-700">
      <Link to="/servers">
        <div className="w-20 h-20 m-4 cursor-pointer bg-red-800 hover:bg-red-600 rounded-full flex items-center justify-center text-gray-400 font-bold text-xl  hover:text-white shadow-md transition-transform duration-300 transform hover:scale-115">
          <Plus />
        </div>
      </Link>
